...
void extractIndsfromDosagematrixDisk(const SNPmatrix<SNPvectorClass> &other, const intVec &keep, std::string path_str,
                                  SNPmatrix<SNPvectorClass> &newMat) {
  throw std::runtime_error("I don't have the Inds extracting for a dosage matrix on file ready yet !");
}
...
template <typename SNPvectorClass, typename intVec>
SNPmatrix<SNPvectorClass> extractIndsfromDOSmatrixDisk(const SNPmatrix<SNPvectorClass> &other, const intVec &keep, std::string path_str) {
